                    ...
                    <div class="cart_table">
                        <table class="table">
                            ...
                            <tbody>
                               ...
                               <?php $subtotal += ($data->price * $data->quantity) ?>
                                <tr>
                                    <td>
                                        <div class="cart_product">
                                            <img src="{{ asset('backend/product/'.$data->image) }}" alt="image_not_found">
                                            <h3><a href="shop_details.html">{{ $data->name }}</a></h3>
                                        </div>
                                    </td>
                        ...
                        <div class="row">
                            <div class="col col-lg-6">
                                    <div class="coupon_form form_item mb-0">
                                        <input type="text" class="txtcoupon" name="coupon" placeholder="Coupon Code...">
                                        <button type="submit" class="btn-coupon btn btn_dark">Apply Coupon</button>
                                        <div class="info_icon">
