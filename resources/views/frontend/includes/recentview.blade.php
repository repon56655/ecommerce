                    ...
                    <div class="viewed_products_wrap arrows_topright">
                        <div class="viewed_products_carousel row" data-slick='{"dots": false}'>
                            <div class="slider_item col">
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{ asset('frontend') }}/assets/images/viewed_products/viewed_product_img_1.png" alt="image_not_found">
                                    </div>
                                ...
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{ asset('frontend') }}/assets/images/viewed_products/viewed_product_img_2.png" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                            ...
                            <div class="slider_item col">
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{ asset('frontend') }}/assets/images/viewed_products/viewed_product_img_3.png" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                ...
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{ asset('frontend') }}/assets/images/viewed_products/viewed_product_img_4.png" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                            ...
                            <div class="slider_item col">
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{ asset('frontend') }}/assets/images/viewed_products/viewed_product_img_5.png" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                ...
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{ asset('frontend') }}/assets/images/viewed_products/viewed_product_img_6.png" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
